...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.updateDetail = function (user) {
        return this.http.put(this.config.apiUrl + '/users' + /* + user.id +*/ '/UpdateDetail', user, this.jwt()).map(function (response) { return response.json(); });
    };
    ...
    UserService.prototype.populate = function () {
        ...
        if (currentUser.getToken()) {
            this.getById(currentUser.Id)
                .subscribe(function (data) { return _this.getById(data.user.Id); });
        }
        else {
